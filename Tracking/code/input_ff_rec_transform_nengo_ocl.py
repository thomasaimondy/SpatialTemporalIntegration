    ...
    if recurrentLearning:                               # L2 recurrent learning
        ...
        if learnFunction:
            if funcType == 'vanderPol':
                ...
                Nexc = 20                                 # number of excitatory neurons
...
if __name__ == "__main__":
    ...
    with mainModel:
        ...
        print("ratorIN probeable list:",ratorIn.probeable)
    ...
    def save_data(endTag):
        ...
        with contextlib.closing(
            ...
            data_dict['ratorOut'] = sim.data[ratorIn_probe]#input in figure
            data_dict['ratorOut2'] = sim.data[ratorOut_probe]# pred
            ...
            data_dict['rateEvolve'] = rateEvolveFn(sim.trange())#ref
            if errorLearning:
                data_dict['recurrentLearning'] = recurrentLearning
                data_dict['error'] = sim.data[errorOn_p]
                data_dict['error_p'] = sim.data[error_p]# err
